...
/**
 * Test Script for Cron Ingestion Endpoint
 * 
 * This script tests the scheduled ingestion endpoint locally.
 * 
 * Usage:
...
async function testCronEndpoint() {
  ...
  console.log('🧪 Testing cron ingestion endpoint...');
  ...
  try {
    ...
    console.error('❌ Network error testing cron endpoint:', (error as Error).message);
